...
function linkgather_render_admin_page() {
    ...
    $post_type    = isset( $_GET['lg_post_type'] ) ? sanitize_text_field( wp_unslash( $_GET['lg_post_type'] ) ) : '';
    ...
    echo '<label for="lg_post_type">' . esc_html__( 'Post Type:', 'linkgather' ) . '</label> ';
    echo '<select name="lg_post_type" id="lg_post_type">';
